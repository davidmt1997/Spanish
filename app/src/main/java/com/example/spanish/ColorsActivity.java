...
public class ColorsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        words.add(new Word("dusty yellow", "amarillo claro", R.drawable.color_dusty_yellow, R.raw.amarillo_claro));
        ...
        words.add(new Word("yellow", "amarillo", R.drawable.color_mustard_yellow, R.raw.amarillo));
