...
public class FamilyMembersActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        words.add(new Word("older brother", "hermano mayor", R.drawable.family_older_brother, R.raw.hermano_mayor));
        words.add(new Word("older sister", "hermana mayor", R.drawable.family_older_sister, R.raw.hermana_mayor));
        words.add(new Word("younger brother", "hermano pequeño", R.drawable.family_younger_brother, R.raw.hermano_pequeno));
        words.add(new Word("younger sister", "hermana pequeña", R.drawable.family_younger_sister, R.raw.hermana_pequena));
